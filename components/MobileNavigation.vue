<template>
  <div class="mobile-navigation">
    <nav class="offcanvas-navigation" id="offcanvas-navigation">
      <ul>
        <li>
          <n-link to="/o-nama">O nama</n-link>
        </li>
        <li class="has-children">
          ...
          <ul class="sub-menu">
            ...
            <li>
              <n-link to="/marketing-na-drustvenim-mrezama">Marketing na društvenim mrežama</n-link>
            </li>
            <li>
              <n-link to="/search-engine-optimizacija">SEO</n-link>
            </li>
            <li>
              <n-link to="/optimizacija-konverzija"
                >Optimizacija konverzija</n-link
              >
            </li>
            <li>
