          ...
          <div class="service-details">
            <div class="service-details-list">
              ...
              <p>
                ...
                text ever since the 1500s, when an unknowne printer took a
                galley of type andscrambled it to make a type specimen book. It
                has survived not only five centuries, but also the leap into
                electronic typesetting, remaining essent ially unchanged. It was
                popularised in the 1960s with the release of Letraset sheets
                containing Lorem Ipsum passages, and more recently with desktop
                publishing software Aldus PageMaker including versions of Lorem
                Ipsum.
              </p>
              ...
              <p>
                ...
                has survived not only five centuries, but also the leap into
                electronic type setting, remaining essent ially unchanged. It
        ...
        <div class="service-details-list">
          <div class="row mtn-35">
            <div class="col-lg-7 mt-35">
              ...
              <p>
                Lorem Ipsum is simply dummy text of the printing and typesetting
                industry. Loriem Ipsum has been the industry's standard dummy
                text ever since the 1500s, when and unknowne printer took a
                galley type andscrambled it to make a type specimen book. It has
                andsurvived not only five centuries but also the leap into
                electronic typesetting, remaining essent ially unchanged. It was
                popularised 1960s with the release of Letraset sheets.
              </p>
              <p>
                Lorem Ipsum is simply dummy text of the printing and typesetting
                industry. Loriem Ipsum has been the industry's standard dummy
                text ever since the 1500s, when and unknown printer took a
                galley type and scrambled it to make a type specimen book. It
                has andsurvived not only five centuries but also the leap into
          ...
          <div class="row mtn-35">
            ...
            <div class="col-12 col-lg-6 mt-35">
              ...
              <p>
                ...
                industry has been an industry's standard dummy text ever since
                the 1500 when an unknowne printer took a galley of type and
