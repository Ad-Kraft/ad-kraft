                ...
                <div class="col-md-8 mt-35">
                    <div class="service-details">
                        <div class="service-details-list">
                            ...
                            <p>Digitalni marketing je širok pojam koji opisuje skup marketinških procesa koji koriste sve raspoložive digitalne kanale za promovisanje proizvoda/usluge ili za izgradnju brenda. Sve naše kampanje uvijek se završavaju na isti način – USPJEŠNO, to postižemo kroz individualnost i fokusiranost na klijenta. Garantujemo postizanje postavljenih ciljeva, poput povećanja prodaje, poziva, emailova ili povećanja informisanosti Vaših klijenata o Vašem proizvodu, uslugama ili brendu. Saznajte zašto nas svi preporučuju koji nas poznaju.</p>

                            <h6 class="text-dark">Ad Kraft digitalna agencija nudi usluge digitalnog marketinga na svim poljima gdje postoji prilika za klijenta da poboljša svoje poslovanje.</h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-details-list">
                    <div class="row mtn-35">
                        <div class="col-lg-6 mt-35">
                            ...
                            <p>Marketing putem emaila pruža direktnu vezu s ciljanom publikom i omogućava Vam najbolji povrat ulaganja. Obratite se svojim trenutnim i potencijalnim kupcima i obavještavajte ih o najnovijim ponudama i novostima Vaše kompanije. Ekstremno su korisne za retenciju klijenata kao i za povećanje povjerenja prema brendu.</p>
                        </div>
                        <div class="col-lg-6 mt-35">
                ...
                <div class="service-details-list">
                    <div class="row mtn-35">
                        <div class="col-lg-5 mt-35 order-2 order-md-1">
                            <img style="max-width:280px" src="/images/service-details/digitalni-marketing/SEO-Search-Engine-Optimizacija-Agencija-za-digitalni-marketing-i-izradu-web-stranica.webp" alt="images-not_found" />
                        </div>
                        <div class="col-lg-7 mt-35 order-1 order-md-2">
                            <h3 class="text-dark">YouTube marketing</h3>
                            <p>YouTube je drugi po veličini pretraživač na svijetu, odmah nakon Google-a, što ga čini plodnim tlom za digitalni marketing.
                ...
                <div class="service-details-list">
                    <div class="row mtn-35">
                        ...
                        <div class="col-lg-3 mt-35 order-2 order-md-1">
                            <img style="max-width:280px" src="/images/service-details/digitalni-marketing/Email-marketing-Agencija-za-digitalni-marketing-i-izradu-web-stranica-Ad-Kraft.webp" alt="images-not_found" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row mtn-30">
                       ...
                       <div class="col-md-6 mt-30" data-aos="fade-up" data-aos-delay="500">
                        ...
                        <div class="col-md-6 mt-30" data-aos="fade-up" data-aos-delay="500">
                            <div class="service-card">
                                <div class="service-content">
                                    <h5 class="text-dark">Odličan omjer uloženog i dobivenog</h5>
                                    <p>Digitalni marketing ne zahtjeva prevelika ulaganja. Male firme mogu pronaći kvalitetan kanal digitalnog oglašavanja koji njima najbolje odgovara, a uklapa se i u njihov budžet.</p>
                                </div>
                            </div>
                        </div>
                        <!-- service-card end -->
