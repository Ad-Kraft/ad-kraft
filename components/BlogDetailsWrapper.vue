        ...
        <div class="col-lg-8 ps-xl-7">
          ...
          <div class="service-details">
            <div class="service-details-list">
              ...
              <p class="mb-2">
                ...
                dummy text ever since the 1500s, when an unknowne printer took a
                galley of type and scrambledit to make a type specimen book. It
                has survived not only five centuries, but also the leap into
                electronic typese tting, remaining essentially unchanged. It was
                popularised
              </p>

              <p class="mb-2">
                Lorem Ipsum is simply dummy text of the printing and type
                setting industry. Lorem Ipsum has been the industry standard
                dummy text ever since the 1500s, when an unknowne printer took a
                galley of type and scrambled it to make a type specimen book. It
                has survived not only five centuries, but also the leap into
                electronic typesetting ially unchanged. It was popularised in
          ...
          <div class="service-details">
            <div class="service-details-list d-md-flex">
              <img
                class="align-self-center mr-md-5 mt-4 mt-lg-0"
              ...
              <div class="content flex-one">
                ...
                <p class="mb-4">
                  Lorem Ipsum is simply dummy text of the printing and type
                  setting printer took a galley of type and scrambled it to make
                  a type spe cimen book. It has survived not only five
              ...
              <div class="col-md-4 mb-4 col-6 order-2 order-md-0">
                <div class="service-next service-media">
                  <div class="content">
                    ...
                    <n-link :to="`/${articles.slug}`" class="link"
